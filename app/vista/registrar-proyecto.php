<?php
    ...
    if(strnatcasecmp($idGestion_, "")!=0)
    {
        ...
        if (!is_array($verP)) 
        {
            ...
            echo"<script type=\"text/javascript\">alert('El registro ha sido satisfactorio'); window.location='inscripcion-proyecto.php';</script>";     
        }
        echo"<script type=\"text/javascript\">alert('El proyecto ya ha sido registrado anteriormente'); window.location='inscripcion-proyecto.php';</script>"; 
    }
    else
    {
       echo"<script type=\"text/javascript\">alert('No se pudo registrar el proyecto, primero debe registrar una gestion'); window.location='inscripcion-proyecto.php';</script>";    
    }
