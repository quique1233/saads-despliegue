...
if (isset($_POST['proyecto'])) {
    ...
    if (!is_array($VerificarIns2))
    {
        ...
        if(strnatcasecmp($proyecto, "Seleccione un proyecto")!=0)
        {
           ...
           echo"<script type=\"text/javascript\">alert('Por favor, seleccione un proyecto'); window.location='../vista/inscripcion-grupo-proyecto.php';</script>";  
        }
    }
    else{
          echo"<script type=\"text/javascript\">alert('Usted ya se registro a un proyecto'); window.location='../vista/inscripcion-grupo-proyecto.php';</script>";  
