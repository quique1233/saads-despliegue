$(document).on('ready', function() {
    ...
    $(document).on('click', '#SeguimientoSemanal', function(e) {
        ...
        e.preventDefault();
        $('#page-wrapper').load('vista-seguimiento-semanal.php');
    });
    ...
    $(document).on('click', '.btnRegistroAsistenciaSemanal', function() {
        ...
        $('.modalRegistroAsistencia').find('.modal-body').load('vista-modal-seguimiento-semanal.php', {
            funcion:funcion,
            usuario:usuario
        });
     ...
     $(document).on('click', '.btnRegistroReportesSemanal', function() {
        ...
        var fila = $(this).parents().get(1);
        var usuario = $(fila).data('usuario');
        $('.modalRegistroReportes').find('.modal-body').load('vista-modal-seguimiento-semanal.php', {
            funcion:funcion,
            usuario:usuario
        });
      ...
      $(document).on('click', '.btnSeguimientoSemanal', function() {
        ...
        var fila = $(this).parents().get(1);
        var usuario = $(fila).data('usuario');
        $('.modalSeguimiento').find('.modal-body').load('vista-modal-seguimiento-semanal.php', {
            funcion:funcion,
            usuario:usuario
        });
