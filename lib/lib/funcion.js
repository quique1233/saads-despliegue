$(document).on('ready', function() {
    ...
    $(document).on('click', '#registrarPlanificacion', function(e) {
        e.preventDefault();
        $('#page-wrapper').load('vista-registrar-planificacion.php');
    });
    
    $(document).on('click', '#Seguimiento', function(e) {
        e.preventDefault();
        $('#page-wrapper').load('vista-seguimiento.php');
    });
    ...
    $(document).on('click', '.btnRegistroAsistencia', function() {
        ...
        $('.modalRegistroAsistencia').find('.modal-body').load('vista-modal-seguimiento.php', {
            funcion:funcion,
            registro:registro
        });
    ...
    $(document).on('click', '.btnRegistroReportes', function() {
        ...
        var fila = $(this).parents().get(1);
        var registro = $(fila).data('registro');
        $('.modalRegistroReportes').find('.modal-body').load('vista-modal-seguimiento.php', {
            funcion:funcion,
            registro:registro
        });
